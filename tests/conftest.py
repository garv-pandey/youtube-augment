...
EDGE_URLS = [
    ...
    {
        # public video in valid private playlist
    ...
    {
        # valid private video in private playlist, ERROR: [youtube] HkeLXf7sYGM: Private video. Sign in if you've been granted access to this video. Use --cookies-from-browser or --cookies for the authentication. See  https://github.com/yt-dlp/yt-dlp/wiki/FAQ#how-do-i-pass-cookies-to-yt-dlp  for how to manually pass cookies. Also see  https://github.com/yt-dlp/yt-dlp/wiki/Extractors#exporting-youtube-cookies  for tips on effectively exporting YouTube cookies        "url": "https://www.youtube.com/watch?v=HkeLXf7sYGM&list=PLlAZKtV48pBbC4nlImTJtM7TVGl0aEolC&index=6",
        "url": "https://www.youtube.com/watch?v=HkeLXf7sYGM&list=PLlAZKtV48pBbC4nlImTJtM7TVGl0aEolC&index=2",
        "video_id": "HkeLXf7sYGM",
        "playlist_id": "PLlAZKtV48pBbC4nlImTJtM7TVGl0aEolC",
    },
    {
        # oversiplified punic war 1 part 2 in top episodes
        # this is legacy url, contains the list of video ids present in playlist and no playlist id.
        # cannot determine whcih video is playing from the list.
        # hence, not supported.
